 ...
 */
static const char* BITCOIN_PID_FILENAME = "bitkanda.pid";
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/bitkanda/bitkanda>";
    const std::string URL_WEBSITE = "<https://github.com/bitkanda/bitkanda/wiki>";
